...
describe('Phase 1 acceptance', () => {
  it('registers every module in the set', () => {
    ...
    // doc comment), and Binaural, the first of three psychoacoustic
    // tone-generation modules (see binaural.ts's own doc comment).
    expect(ALL_DESCRIPTORS.length).toBe(24)
  })
